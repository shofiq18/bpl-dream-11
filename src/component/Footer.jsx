...
const Footer = () => {
    return (
        ...
        <div className=" mt-96 relative bg-[#06091A] pt-60">
            ...
            <div className='absolute p-5 border border-white rounded-xl text-center -top-44 left-0 right-0 mx-auto   max-w-7xl'>
               <div className='bg-gradient-to-r from-blue-200 to-yellow-200  rounded-xl py-20 w-full'>
               <h2 className='font-bold text-black text-3xl mb-4 text-center'>Subscribe to our Newsletter</h2>
                ...
                <button className="bg-gradient-to-r from-pink-300 to-yellow-300 text-black font-bold py-3 px-4 rounded-xl transform transition-transform duration-200 hover:scale-105">Subscribe</button>
                </div>
               </div>
            </div>
